<template>
    <div>
      ...
      <div class="select">
        ...
        <el-select v-model="splitterValue" clearable :isDisabled=isSplitterDisabled placeholder="请选择Spliter">
          <el-option
        ...
        <el-select v-model="brandValue" clearable :isDisabled=isBrandDisabled placeholder="请选择Brand">
          <el-option
