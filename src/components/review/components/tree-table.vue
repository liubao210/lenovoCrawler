<template>
	<div class="tree-table">
		<div class="tree-head">
			<table>
				<tr>
					<td class="td1">Spliter</td>
					<td class="td2">Brand</td>
            ...
            series
					...
					<td class="td4">subseries_name</td>
					<td class="td5">model_name</td>
					<td class="td6">price</td>
          <td class="td6">price</td>
				</tr>
			</table>
		</div>
    ...
    .tree-head {
      padding-left: 30px;
		...
		.tree-body {
			...
			.leve-1 .td-title a { width: 200px; }
			.leve-2 .td-title a { width: 170px; }
			.leve-3 .td-title a { width: 140px; }
			.leve-4 .td-title a { width: 110px; }
			.leve-5 .td-title a { width: 80px; }
			.leve-6 .td-title a { width: 50px; }
			.leve-7 .td-title a { width: 20px; }
