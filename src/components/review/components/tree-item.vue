        ...
        <td :colspan="colSpan">
          <table>
              <tr class="leve" :class="levelClass">
                <td class="td1">
                  <div class="td-title" @dblclick="handlerExpand(model)">
                    ...
                    <a class="ellipsis">
                      ...
                      <span :title="model.ObjectName">{{model.spliter_name}}</span>
                    </a>
                  </div>
                </td>
                <td class="td2">
                ...
                <td class="td3">{{model.series_id|formatDate}}</td>
                <td class="td4">
                  <span :title="model.Experience" class="ellipsis">{{model.subseries_name}}</span>
                </td>
                <td class="td5">{{model.model_id}}</td>
                <td class="td5">{{model.model_name}}</td>
                <td class="td6">
